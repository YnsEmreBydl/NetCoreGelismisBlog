...
{
    public partial class addmigrationnew_blog : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AboutDeteils1 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AboutDeteils2 = table.Column<string>(type: "nvarchar(max)", nullable: true),
